...
def euler54(hands)
  ...
  1000.times do |i|
    result = poker_compare(poker_hand(hands_array[i][0..13]), poker_hand(hands_array[i][15..28])) 
	if result == 1 then player_1_wins += 1 end
	if result == 2 then player_2_wins += 1 end
  end
  
  player_1_wins
end

answer = euler54(hands)
